...
Ele estava no posto de arrecadação,
Jesus parou, fitou os olhos e chamou sua atenção.
"Segue-me agora", e Levi se levantou,
Ele não pediu tempo, logo o acompanhou.
Em sua casa deu um banquete e seus amigos foi chamar,
Os fariseus e os escribas começaram a criticar.
"O seu mestre está sentado junto à mesa com ladrão",
Mas Jesus sabia bem qual era a intenção.
"Não os que têm saúde precisam de doutor,
Mas sim os pecadores", respondeu o meu Senhor.`
    },
    {
      id: 'p1-37-new',
      title: 'Chamado e Luz',
      text: `Tens um chamado, um caminho a seguir.
Perdoa nesta jornada, o Espírito está aqui.
Faz de ti um modelo vivo, a paz que vem do amor,
em resposta à oração, dons Deus derramou.
Eu consolo tua vida, sê luz em meio à dor.
Teu nome tem história, consagra o teu amor.
Abre agora teus ouvidos, tua boca para falar.
O Espírito Divino está aqui para te escutar.`
    },
    {
      id: 'p1-38-new',
      title: 'O Chamado do Oleiro',
...
Somos os que creem com fé: Deus vai nos salvar.`
    },
    {
      id: 'p1-40-new',
      title: 'Chamado à Santificação',
      text: `Hoje é o dia da graça se revelar,
meu Senhor me chama para me santificar.
Sou escolhido para falar,
anunciar o evangelho, e em Cristo, adorar.
Teu nome exalto com devoção,
glorifico Teu Reino, e com fé, sigo a Tua direção.
O Cordeiro está no trono, em Seu brilho divino,
e eu sou chamado para seguir Seu caminho.
Sou separado para adorar,
para morar junto de Cristo, e Sua luz irradiar.
O pecado não tem mais domínio sobre mim,
pois em Jesus, encontrei meu verdadeiro fim.
Agora, sigo em fé, com o coração ardente,
anunciando o Reino, com Cristo, eternamente.`
    },
    {
      id: 'p1-41-new',
      title: 'Resposta ao Chamado',
...
e crer.`
    },
    {
      id: 'p1-48-new',
      title: 'O Poder da Mente e do Amor Próprio',
      text: `Quem pensa, enriquece,
Pois o Senhor não esquece
Daqule a quem prometeu:
"Se creres, farás obras maiores do que Eu."
Não saia da Sua presença,
Aumente sua fé, sua crença
Naquele que criou e te formou —
Teu Senhor, teu Deus, teu Salvador.
Tua mente é poderosa,
Mas se mal direcionar,
Pensarás que não consegue,
E hoje não irá triunfar.
Viva agora, no presente,
Sinta o sopro do ar,
Esse sopro é divino, é o Senhor
A te ensinar a despertar.
O ser que habita em ti,
Só floresce com amor.
Depende do teu cuidado,
Do reconhecimento do teu valor.
Deus é contigo, sempre será,
Essa verdade não se apagará.
Mas para viver em paz, com sucesso,
Uma coisa só te peço:
Nunca se esqueça de você,
Pois é o amor próprio que te faz florescer.`
    },
    {
      id: 'p1-49-new',
      title: 'Reflexões Sobre o Passado e o Futuro',
...
E escolha, com sabedoria, a direção do seu coração.`
    },
    {
      id: 'p1-51-new',
      title: 'O Milagre da Escrita',
      text: `Tantos passam sem perceber,
mas ao escrever, o milagre começa a florescer.
No silêncio da mente, um pensamento se eleva,
e no ato de escrever, algo novo se revela.
O presente se torna eternidade,
e as palavras, ao nascer, ganham liberdade.
Sinta, cada frase que brota do coração,
é a criação de um novo caminho, uma nova canção.
Do pensamento ao sentimento,
surge a emoção que transforma o momento.
Ao escrever, você vê mais claro,
o milagre da escrita, tão simples e tão raro.`
    },
    {
      id: 'p1-52-new',
      title: 'As Vozes que Ouvimos',
      text: `Quais são as vozes que falam em tua mente?
Qual delas te chama e qual te faz desistir?
São muitas, mas há uma que se destaca,
uma voz suave, que traz paz e esperança.
Ela te envolve com suavidade,
fazendo com que te sintas em serenidade.
O medo vai embora, e com ele a timidez,
pois essa voz traz calma, e alivia a sua rigidez.
Sinta o vento leve e a respiração tranquila,
deixe a voz que te chama acalmar tua agitação.
Ela é a voz da paz, da liberdade,
que te leva à serenidade, e à pura felicidade.`
    },
    {
      id: 'p1-53-new',
      title: 'A Passagem',
...
começa hoje, aqui, em mim.`
    },
    {
      id: 'p3-31-new',
      title: 'Transformação — Um Processo Necessário',
      text: `Para que haja transformação,
o ser precisa passar por moldação.
Lembra da borboleta no casulo apertado?
Ali, em silêncio, está sendo transformado.
Sofre dores que precisa enfrentar,
mas logo, em asas, poderá voar.
Assim também é o ouro, em sua essência,
pedra bruta que exige paciência.
Do sólido ao líquido, o fogo faz derreter —
não pode voltar atrás, precisa crescer.
É um processo árduo, doloroso, essencial,
para que o ouro alcance seu valor final.
Como a argila nas mãos do oleiro,
que, antes de vaso, é amassada primeiro.
Moléculas se unem no sofrimento,
um processo doloroso, mas com fundamento.
A chave está na prontidão do coração,
no desejo sincero por transformação.
Como Jesus, que se entregou sem reclamar,
aceitou a dor e escolheu continuar.
Cada transformação exige aceitação,
abrir mão do ego, da própria razão.
Jesus é o modelo da paciência,
passou pelo processo com obediência.
Se queremos ser moldados, renovados,
devemos aceitar ser quebrados.
Seremos amassados, queimados, purificados,
até que sejamos transformados.
O artista é Deus, com mãos de criação,
visualiza em nós Sua inspiração.
Mas é preciso aceitar com coração aberto,
o processo, mesmo quando parece deserto.
Desde o nascimento, a dor nos acompanha,
sair do ventre exige coragem tamanha.
O sofrimento é parte da formação,
nos guia ao alto, à elevação.
Se pedimos transformação, devemos compreender,
que o caminho pode exigir doer.
Mas com fé, coragem e entrega verdadeira,
chegaremos à essência derradeira.
Fica a reflexão sincera no ar:
estamos prontos para nos deixar moldar?
Mesmo sem entender totalmente,
a transformação exige fé e mente paciente.`
    },
    {
      id: 'p3-32-new',
      title: 'Reflexões sobre Transformação',
...
“O que fizeste com o tempo que te dei pra transformar?”`
    },
    {
      id: 'p3-34-new',
      title: 'O Caminho da Restauração',
      text: `Lembra-te de Bartimeu — ele se posicionou,
Gritou pedindo a Cristo, e sua visão se restaurou.
Mas antes, enfrentou uma grande multidão...
Até quando vai ficar prostrado, meu irmão?
O Senhor está esperando você se levantar,
Com fé no coração, suas feridas vai curar.
Você se lembra daquele dia que encheu o teu coração,
Quando estava perdido, buscando luz na escuridão?
Ele estava contigo, te mostrando a direção.
Hoje, estou trabalhando, restaurando tua memória,
Colorindo tua vida, reescrevendo tua história.
Estou cuidando de você... puxe a âncora, vá em frente!
Tua barca vai levar minha mensagem e curar muita gente.
O Senhor está restaurando o leme do teu barco,
No mar da tua vida, Eu te pego no teu abraço.
Agradeço ao Senhor por tudo que Ele já fez,
O Espírito renova tua vida mais uma vez.`
    },
    {
      id: 'p3-35-new',
      title: 'Gratidão e Renovação em Deus',
...
Deus venha ordenar os teus lábios, filho, vem me adorar.`
    },
    {
      id: 'p4-29-new',
      title: 'O Grito de Aflição',
      text: `Eu ouvi o grito de aflição do meu povo,
Senti a ferida em seus corações.
Hoje, venho para curar e salvar.
Assim diz o Senhor, que vem sarar todas as feridas,
Pois em Deus reside o amor,
Que é puro e o princípio da vida.
Não busque apenas a cura física,
Mas procure Aquele que é a fonte da vida.
O Senhor te oferece a verdadeira felicidade
Para que possas ser salvo e viver plenamente.
Ele ouve mesmo quando não consegues expressar em palavras,
Ele guia teu coração para que não tropeces em Sua presença.
Converse sempre com Ele,
Ouve-O com devoção e busque entender o que Ele deseja de ti.
Pergunte ao Senhor celestial qual é o sinal do coração.
Pois Deus te fez à Sua imagem e semelhança,
Infundindo vida em ti pelo sopro do Espírito.
O desafio de compreender a vontade de Deus
Leva-te a perceber que o homem não pode compreendê-Lo totalmente,
Mas Deus é todo-poderoso.
Ele está presente em cada respiração,
Seu amor permeia nossa jornada e nossa missão.`
    },
    {
      id: 'p4-30-new',
      title: 'Entrega e Louvor',
...
Ele é a verdade, reconheça a salvação.`
    },
    {
      id: 'p5-32-new',
      title: 'Caminhando na Fé',
      text: `Olá, com certeza posso te ajudar,
